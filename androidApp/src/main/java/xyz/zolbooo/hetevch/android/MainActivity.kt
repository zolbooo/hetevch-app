...
import xyz.zolbooo.hetevch.usecase.BudgetStatus
import xyz.zolbooo.hetevch.usecase.GetBudgetStatusUseCase
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val startDestination = when (getBudgetStatusUseCase.getBudgetStatus()) {
